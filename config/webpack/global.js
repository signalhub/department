...
module.exports = function(_path) {
    ...
    const aliases = {
        ...
        _template: path.join(appPath, 'public')
    };
    ...
    return {
        ...
        module: {
            loaders: [{
                ...
                loader: 'file-loader?context=' + aliases._src + '&name=[path][name].[hash].[ext]',
            }, {
        ...
        plugins: [
            ...
            new HtmlPlugin({
                title: 'React ListItems',
                chunks: ['vendors', 'application'],
                filename: 'index.html',
                extraFiles: [],
                template: path.join(aliases._template, 'index.html'),
            }),
